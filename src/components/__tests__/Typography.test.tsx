...
describe('Typography', () => {
  ...
  it('applies custom color correctly', () => {
    ...
    const { getByText } = render(
      <Typography color={testColor}>Colored Text</Typography>
    );
  ...
  it('applies custom styles correctly', () => {
    ...
    const { getByText } = render(
      <Typography style={customStyle}>Custom Styled Text</Typography>
    );
  ...
  it('handles numberOfLines prop correctly', () => {
    const { getByText } = render(
      <Typography numberOfLines={2}>Multi-line text</Typography>
    );
  ...
  it('handles adjustsFontSizeToFit prop correctly', () => {
    const { getByText } = render(
      <Typography adjustsFontSizeToFit>Auto-sizing text</Typography>
    );
